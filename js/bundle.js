...
app.MapView = require('./views/MapView.js');
/*
...
$(document).ready(function() {
  ...
  mapView.render();
  $.getJSON("js/data/states/CA.json", function(data) {
    mapView.parseData(data);
  });
// var featureLayer = omnivore.topojson('js/data/us.json').addTo(app.map);
 // $.getJSON("js/data/us.json", function(data){
 //  var features = topojson.feature(data, data.objects.states);
 //  app.statelayer = L.mapbox.featureLayer(features).addTo(app.map);
 //  mapView.addArrests();
 //  console.log(app.stateLayer);
 // });
...
},{"./views/MapView.js":2}],2:[function(require,module,exports){
